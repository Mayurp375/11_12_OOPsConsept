...
class boiATM implements AtMmachin { //implimentation of interface in the class
    private int password = 1234; //fetch value by encapsulation method getttes and setters
    ...
    public void ballanceCheck() {
        ...
        if (pass == getPassword()) {//if pin correct then check ballence
    ...
    public static void main(String[] args) {
        ...
        int hint = scanner.nextInt();//using switch case this will choose the program
